...
var KTTablesWidget4 = (function () {
    ...
    const l = () => {
        ...
        o = [
            { name: "Go Pro 8", description: "Latest  version of Go Pro.", cost: "500.00", qty: "1", total: "500.00", stock: "12" },
            { name: "Bose Earbuds", description: "Top quality earbuds from Bose.", cost: "300.00", qty: "1", total: "300.00", stock: "8" },
            { name: "Mathematics", cost: "89.00", qty: "1", total: "89.00", stock: "18" },
            { name: "Apple Airpod 3", description: "Apple's latest earbuds.", cost: "200.00", qty: "2", total: "400.00", stock: "32" },
            { name: "Nike Pumps", description: "Apple's latest headphones.", cost: "200.00", qty: "1", total: "200.00", stock: "8" },
        ],
        r = () => {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                ...
                s = {
                    ...
                    stroke: { show: !0, width: 2, colors: ["transparent"] },
                    xaxis: {
                        categories: ["Mr Jeremiah Adams", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"],
                        axisBorder: { show: !1 },
                        axisTicks: { show: !1 },
                        labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px" } },
                        crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } },
            ...
            if (e) {
                var a = parseInt(KTUtil.css(e, "height")),
                    ...
                    s = new ApexCharts(e, {
                        ...
                        xaxis: {
                            categories: ["", "Apr 02", "Apr 03", "", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 17", "Apr 18", "Apr 19", "Apr 21", ""],
                            axisBorder: { show: !1 },
                            axisTicks: { show: !1 },
                            tickAmount: 6,
...
var KTChartsWidget22 = (function () {
    var e = function (e, a, t, l) {
        ...
        if (o) {
            ...
            var r = {
                    ...
                    stroke: { width: 0 },
                    labels: ["Attendance", "Attendance", "Attendance", "Attendance"],
                    legend: { show: !1 },
                    fill: { type: "false" },
                },
    ...
    return {
        init: function () {
            e("#kt_chart_widgets_22_tab_1", "#kt_chart_widgets_22_chart_1", [20, 100], !0), e("#kt_chart_widgets_22_tab_2", "#kt_chart_widgets_22_chart_2", [70, 13, 11, 2], !1);
        },
    };
})();
...
var KTChartsWidget32 = (function () {
        ...
        if (o) {
            var r = parseInt(KTUtil.css(o, "height")),
                ...
                s = {
                    ...
                    stroke: { show: !0, width: 2, colors: ["transparent"] },
                    xaxis: {
                        categories: ["Mr Jeremiah Admas", "Mr Acholo Precious", "Adeola Adeyemi", "Victor Fadipe", "Daniel Lewy", "Madam Koi Koi", "Silas Oparaiwu"],
                        axisBorder: { show: !1 },
                        axisTicks: { show: !1 },
                        labels: { style: { colors: KTUtil.getCssVariableValue("--bs-gray-800"), fontSize: "13px" } },
                        crosshairs: { fill: { gradient: { opacityFrom: 0, opacityTo: 0 } } },
                    },
    ...
    return {
        init: function () {
            e("#kt_charts_widget_32_tab_1", "#kt_charts_widget_32_chart_1", [100, 95, 90, 82, 80, 75, 70], !0),
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    t = {
                        ...
                        xaxis: {
                            categories: ["JSS 1A", "JSS 2A", "JSS3 B"],
                            labels: {
                                formatter: function (e) {
                                    return e + "Student";
                                },
        ...
        !(function () {
            ...
            if (e) {
                var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                    t = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    l = new ApexCharts(e, {
                        student: [{ name: "Sales", data: [15, 12, 10, 8, 7] }],
                        chart: { fontFamily: "inherit", type: "bar", height: 350, toolbar: { show: !1 } },
                        plotOptions: { bar: { borderRadius: 8, horizontal: !0, distributed: !0, barHeight: 50, dataLabels: { position: "bottom" } } },
                        dataLabels: {
                            enabled: !0,
