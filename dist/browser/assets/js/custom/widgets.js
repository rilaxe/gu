    ...
    init: function () {
        ...
        !(function () {
            ...
            a &&
                new ApexCharts(a, {
                    series: [
                        { name: "Females", data: [44, 55, 57, 56, 61, 58] },
                        { name: "Males", data: [76, 85, 101, 98, 87, 105] },
                    ],
                    ...
                    xaxis: { categories: ["JS 1", "JS 2", "JS 3", "SS 1", "SS 2", "SS 3"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: s, fontSize: "12px" } } },
            ...
            (function () {
                ...
                e &&
                    new ApexCharts(e, {
                        series: [
                            { name: "Passed", data: [44, 55, 57, 56, 61, 58] },
                            { name: "Failed", data: [76, 85, 101, 98, 87, 105] },
                        ],
                        ...
                        dataLabels: { enabled: !1 },
                        stroke: { show: !0, width: 2, colors: ["transparent"] },
                        xaxis: { categories: ["JSS 1 ", "JSS 2", "JSS 3 ", "SSS 1", "SSS 2", "SSS 3"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: a, fontSize: "12px" } } },
