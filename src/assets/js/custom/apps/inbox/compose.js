...
var KTAppInboxCompose = (function () {
    const e = (e) => {
        ...
        n = (e) => {
            new Quill("#kt_inbox_form_editor", {  placeholder: "Type your text here...", theme: "snow" });
        ...
        o = (e) => {
            ...
            var l = new Dropzone(t, { url: "https://preview.keenthemes.com/api/dropzone/void.php", parallelUploads: 20, maxFilesize: 1, previewTemplate: r, previewsContainer: t + " .dropzone-items", clickable: n });
