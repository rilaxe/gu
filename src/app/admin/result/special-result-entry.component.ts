...
@Component({
  templateUrl: './special-result-entry.component.html',
  styleUrls: ['result.component.css']
})
export class SpecialResultEntryComponent implements OnInit {
  @Input() header: string;
...
ngOnInit(): void {
  this.genk.topdata = 'Other Result Entry';
  ...
  this.activeRoute.queryParams.subscribe(
    params => {
      ...
      this.genk.topdata = this.examType + ' Result Entry';
    }
  )
