  ...
  fileChange(myFile: any) {
    ...
    //for (let i = 0; i < myfiles.length; i++) {
      ...
      reader.onload = (event: any) => {
        ...
        this.itemo = {src: event.target.result, name: defile.name.substring(0, 14), ext: this.genk.getExt(defile.name).toLowerCase(), size: defile.size};
        this.myfile = defile;
